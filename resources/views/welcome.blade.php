        ...
        <div class="relative flex items-top justify-center min-h-screen bg-light-100  sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h1 style="font-size: 50px; color:red;">Base Api Authentication</h1>

                </div>
                <div class="text-center">

                    <h1 style="font-size: 20px; color:rgb(10, 10, 172);">Tangent Technologies</h1>
                </div>
